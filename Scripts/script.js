...
document.addEventListener("DOMContentLoaded", function() {
    const listings = [
      ...
      },
      {
        ...
        room: "2 Bed, 1 Bath",
        class: "Undergraduate",
        description: "Lease options currently range from 6 - 17 months. Prices and special offers are valid for new residents only. Pricing, lease options, and availability are subject to change at any time.",
...
function searchListings() {
  ...
  const listings = [
    { id: 1, title: "1400 W. Devon Avenue", description: "1 Bed, 1 Bath - $1,175 /mo", location: "Devon Avenue" },
    { id: 2, title: "1135 W Sheridan Rd", description: "2 Bed, 2 Bath - $2,599", location: "Sheridan Rd" },
    { id: 3, title: "6725 N Sheridan Rd", description: "1 Bed, 1 Bath - $1,566", location: "Sheridan Rd" },
    { id: 4, title: "Edgewater Apartment", description: "3 Bed, 2 Bath - $2,000", location: "Edgewater" },
    { id: 5, title: "Rogers Park Flat", description: "2 Bed, 1 Bath - $1,200", location: "Rogers Park" }
  ];
  ...
  if (results.length > 0) {
    ...
    resultsContainer.innerHTML = "<p>No listings found matching your search.</p>";
  }
